# -*- coding: utf-8 -*-
# Copyright (c) 2025 relaskes@gmail.com
#
...
class BilibiliVideo(Base):
    ...
    add_ts = Column(String(32))
    last_modify_ts = Column(String(32))
    video_type = Column(Text)
    title = Column(Text)
    desc = Column(Text)
    create_time = Column(String(32), index=True)
...
class DouyinChat(Base):
    __tablename__ = 'douyin_chat'
    id = Column(Integer, primary_key=True)
    chat_id = Column(String(64), nullable=False, index=True, unique=True)
    source_keyword = Column(Text)
    chat_start = Column(Text)
    chat_timestamp = Column(String(32))
    status = Column(String(32), default='pending')
    add_ts = Column(String(32), nullable=False)
    last_modify_ts = Column(String(32), nullable=False)

class BilibiliChat(Base):
    __tablename__ = 'bilibili_chat'
    id = Column(Integer, primary_key=True)
    chat_id = Column(String(64), nullable=False, index=True, unique=True)
    source_keyword = Column(Text)
    chat_start = Column(Text)
...
class ZhihuChat(Base):
    __tablename__ = 'zhihu_chat'
    id = Column(Integer, primary_key=True)
    chat_id = Column(String(64), nullable=False, index=True, unique=True)
    source_keyword = Column(Text)
    chat_start = Column(Text)
