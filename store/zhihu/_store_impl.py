...
class ZhihuDbStoreImplement(AbstractStore):
    async def store_content(self, content_item: Dict):
        ...
        """
        # Truncate content_text if it's too long to fit in database field
        # Using conservative limit of 10000 characters to avoid VARCHAR overflow
        content_text = content_item.get("content_text", "")
        if content_text and len(content_text) > 10000:
            content_text = content_text[:10000]
            content_item["content_text"] = content_text
